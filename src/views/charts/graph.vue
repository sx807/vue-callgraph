  ...
  <div class="chart-container">
    <el-row :gutter="20">
      <el-col :span="4" :offset="2">
        <el-select v-model="ver" filterable placeholder="选择内核版本">
          <el-option
      ...
      <el-col :span="4">
        <el-input v-model="path1" placeholder="请输入路径" @change="pathchange"></el-input>
      </el-col>
      <el-col :span="4">
        <el-input v-model="path2" placeholder="请输入路径" @change="pathchange"></el-input>
      </el-col>
      <!-- <el-col :span="9">
        <el-select v-model="path1" filterable placeholder="选择路径">
          <el-option
        ...
        <el-select v-model="path2" filterable placeholder="选择路径">
          <el-option
            v-for="item in path_list"
            :key="item"
            :label="item"
